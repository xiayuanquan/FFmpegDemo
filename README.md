...
-----
    ...
    编译：如果本机已经安装过FFmpeg，可以自己去下载脚本进行编译，然后将编译的文件集成到项目中。需要先下载编译脚本：https://github.com/kewlbear/FFmpeg-iOS-build-script。
    然后进入该文件目录，运行命令行./build-ffmpeg.sh。常见编译错误请挪步参考：https://www.jianshu.com/p/5d20e2a50faa。
